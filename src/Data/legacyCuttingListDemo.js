...
export const LEGACY_ROOF_LENGTH_QTY = [
  [9.9, 30],
  [9.8, 2],
  [9.2, 2],
  [8.9, 18],
...
export const LEGACY_FLAT_LENGTH_QTY = [[132.5, 1]];

const roofLines = LEGACY_ROOF_LENGTH_QTY.map(([lengthM, sheets], i) => ({
  lineNo: i + 1,
  lineType: 'Roof',
  sheets,
  lengthM,
...
const flatLines = LEGACY_FLAT_LENGTH_QTY.map(([lengthM, sheets], i) => ({
...
export const LEGACY_CUTTING_LIST_LINES = [...roofLines, ...flatLines];

const roofSheets = LEGACY_ROOF_LENGTH_QTY.reduce((s, [, q]) => s + q, 0);
const flatSheets = LEGACY_FLAT_LENGTH_QTY.reduce((s, [, q]) => s + q, 0);
export const LEGACY_SHEETS_TO_CUT = roofSheets + flatSheets;
export const LEGACY_TOTAL_METERS = LEGACY_CUTTING_LIST_LINES.reduce((s, l) => s + l.totalM, 0);
...
export const LEGACY_QUOTATION_TOTAL_NGN = 27_093_700;
export const LEGACY_RECEIPT_AMOUNT_NGN = 31_202_000;
...
export const LEGACY_QUOTATION = {
  ...
  total: '₦27,093,700',
  totalNgn: LEGACY_QUOTATION_TOTAL_NGN,
  paidNgn: LEGACY_RECEIPT_AMOUNT_NGN,
  paymentStatus: 'Paid',
  status: 'Approved',
  ...
  materialGauge: LEGACY_LINES_JSON.materialGauge,
  materialColor: LEGACY_LINES_JSON.materialColor,
  materialDesign: LEGACY_LINES_JSON.materialDesign,
  quotationLines: {
    products: LEGACY_LINES_JSON.products,
    accessories: LEGACY_LINES_JSON.accessories,
    services: LEGACY_LINES_JSON.services,
  },
};

export const LEGACY_RECEIPT = {
  id: 'RC-2026-1849',
  customerID: 'CUS-NDA',
  customer: 'NDA',
  ...
  dateISO: '2026-08-11',
  amount: '₦31,202,000',
  amountNgn: LEGACY_RECEIPT_AMOUNT_NGN,
...
export const LEGACY_CUTTING_LIST = {
  id: 'CL-2026-1592',
  customerID: 'CUS-NDA',
  customer: 'NDA',
  quotationRef: 'QT-2026-027',
  ...
  date: '11 Aug',
  dateISO: '2026-08-11',
  sheetsToCut: LEGACY_SHEETS_TO_CUT,
  totalMeters: LEGACY_TOTAL_METERS,
  total: `${LEGACY_TOTAL_METERS.toLocaleString('en-NG', { maximumFractionDigits: 2 })} m`,
  status: 'Waiting',
  ...
  handledBy: 'Auwal Idris',
  lines: LEGACY_CUTTING_LIST_LINES,
};
