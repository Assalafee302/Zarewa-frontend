 ...
 * Queue counts live on the Activity zone — do not duplicate TodayWorkCards here.
 */
export default function ActionInbox({
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col gap-3 lg:flex-row" role="region" aria-label="Action inbox">
        ...
        {actionChips.length ? (
          <div className="mb-2 flex flex-wrap gap-1.5" role="group" aria-label="Content filters">
            <button
              ...
              className={`min-h-9 rounded-lg px-2.5 py-2 text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600 ${
