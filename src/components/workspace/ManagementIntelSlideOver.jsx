        ...
        <div className="flex shrink-0 items-start justify-between gap-3 border-b border-slate-200 bg-white px-4 py-3 shadow-sm">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              ...
              className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-ui-xs font-bold uppercase tracking-wide text-slate-700 shadow-sm hover:bg-slate-50"
            >
              Open workstation
            </Link>
            <button
