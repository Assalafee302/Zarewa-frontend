  ...
  return (
    <PrintModalPortal open={open} onClose={onClose}>
      <div className="mx-auto max-w-[210mm] pb-16">
        <div className="no-print sticky top-0 z-10 mb-4 flex flex-wrap items-center justify-between gap-3 rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm">
          <div className="min-w-0">
            ...
            {autoPrint ? (
              ...
              <p className="mt-0.5 text-ui-xs text-slate-500">Portrait A4 — scroll to review, then print.</p>
            )}
          </div>
        ...
        <div className="report-print-root report-print-a4-portrait quotation-print-preview-mode rounded-lg border border-slate-200 bg-white shadow-2xl print:rounded-none print:border-0 print:shadow-none">
