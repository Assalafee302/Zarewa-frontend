      ...
      <div className="z-modal-panel max-w-[min(100%,min(96vw,48rem))] w-full max-h-[min(92vh,820px)] flex flex-col mx-auto">
        ...
        <form className="flex flex-col flex-1 min-h-0" onSubmit={handleSubmit}>
          <div className="flex-1 overflow-y-auto p-5 custom-scrollbar bg-white min-h-0 flex flex-col gap-6">
            ...
            >
              <p className="text-ui-xs text-slate-500 mb-2 leading-snug">
                  ...
                  >
                    ...
                    <div className="lg:col-span-1 flex flex-col gap-0.5 min-w-0">
                      ...
                      <div className="flex flex-nowrap items-center justify-end gap-1.5 min-h-[1.625rem] min-w-0">
                        <p className="text-ui-xs font-bold text-zarewa-teal tabular-nums flex-1 truncate text-right sm:text-left min-w-0">
          ...
          <div className="px-5 py-4 bg-zarewa-teal flex flex-wrap justify-between items-center gap-3 text-white shrink-0 border-t border-[#0f3d39]/30">
            ...
            <div className="flex gap-2 flex-wrap justify-end">
              ...
              <button
                type="submit"
                disabled={busy}
                className="bg-white text-zarewa-teal px-4 py-2.5 rounded-lg text-ui-xs font-semibold uppercase tracking-wide shadow-sm inline-flex items-center gap-2 hover:brightness-105 disabled:opacity-50"
              >
