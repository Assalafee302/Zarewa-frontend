...
export default function ProcurementKpiStrip({ kpis }) {
  const rows = [
    ...
    { label: 'Pending purchase orders', value: kpis.pendingPoCount },
    { label: 'Approved purchase orders', value: kpis.approvedPoCount },
    ...
    { label: 'Stockouts', value: kpis.stockOutIncidents },
