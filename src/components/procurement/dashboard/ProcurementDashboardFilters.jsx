  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-3">
      <div className="grid grid-cols-2 gap-2 md:grid-cols-4 xl:grid-cols-8">
        <label className="text-ui-xs">
          <span className="mb-1 block font-bold uppercase tracking-wide text-slate-500">From</span>
          <input type="date" value={filters.from} onChange={(e) => onChange({ from: e.target.value })} className="z-input !py-1.5 !text-xs" />
        </label>
        <label className="text-ui-xs">
          <span className="mb-1 block font-bold uppercase tracking-wide text-slate-500">To</span>
          <input type="date" value={filters.to} onChange={(e) => onChange({ to: e.target.value })} className="z-input !py-1.5 !text-xs" />
        </label>
        <label className="text-ui-xs">
          <span className="mb-1 block font-bold uppercase tracking-wide text-slate-500">Branch</span>
          <select value={filters.branchId} onChange={(e) => onChange({ branchId: e.target.value })} className="z-input !py-1.5 !text-xs">
        ...
        <label className="text-ui-xs">
          ...
          <select value={filters.supplierId} onChange={(e) => onChange({ supplierId: e.target.value })} className="z-input !py-1.5 !text-xs">
            <option value="all">All</option>
        ...
        <label className="text-ui-xs">
          ...
          <select value={filters.materialClass} onChange={(e) => onChange({ materialClass: e.target.value })} className="z-input !py-1.5 !text-xs">
            <option value="all">All</option>
        ...
        <label className="text-ui-xs">
          ...
          <input value={filters.colour} onChange={(e) => onChange({ colour: e.target.value })} className="z-input !py-1.5 !text-xs" placeholder="Any" />
        </label>
        <label className="text-ui-xs">
          <span className="mb-1 block font-bold uppercase tracking-wide text-slate-500">Gauge</span>
          <input value={filters.gauge} onChange={(e) => onChange({ gauge: e.target.value })} className="z-input !py-1.5 !text-xs" placeholder="Any" />
        </label>
        <label className="text-ui-xs">
          <span className="mb-1 block font-bold uppercase tracking-wide text-slate-500">Transport</span>
          <select value={filters.transportAgentId} onChange={(e) => onChange({ transportAgentId: e.target.value })} className="z-input !py-1.5 !text-xs">
            <option value="all">All</option>
