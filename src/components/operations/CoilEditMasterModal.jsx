...
export default function CoilEditMasterModal({ isOpen, onClose, coil, reservedKg = 0, onSaved }) {
  ...
  return (
    <ModalFrame isOpen={isOpen} onClose={onClose} title="Edit coil master data" showCloseButton={false}>
        ...
        <ModalScrollHeader>
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-2 min-h-11 min-w-11 text-gray-400 hover:text-red-500 rounded-xl shrink-0"
              aria-label="Close"
            >
              <X size={20} />
            </button>
        ...
        <form onSubmit={submit} className="flex min-h-0 flex-1 flex-col overflow-hidden">
          <ModalScrollBody>
            ...
            <div className="space-y-5">
              ...
              <fieldset className="space-y-3 rounded-xl border border-slate-200 bg-slate-50/50 p-3" disabled={busy}>
