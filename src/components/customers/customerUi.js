...
export const CUSTOMER_FIELD =
  'w-full rounded-xl border border-slate-200/90 bg-white py-2.5 px-3.5 text-sm font-semibold text-[#134e4a] outline-none transition-shadow placeholder:text-slate-400 focus:border-teal-300 focus:ring-2 focus:ring-teal-500/15';

export const CUSTOMER_SELECT =
  'w-full rounded-xl border border-slate-200/90 bg-white py-2.5 px-3 text-sm font-semibold text-[#134e4a] outline-none focus:border-teal-300 focus:ring-2 focus:ring-teal-500/15';

export const CUSTOMER_TEXTAREA = `${CUSTOMER_FIELD} resize-none font-medium leading-relaxed`;

export const CUSTOMER_LABEL =
  'text-[10px] font-bold uppercase tracking-widest text-slate-500 ml-0.5';
...
export const CUSTOMER_SECTION_TITLE =
  'text-[10px] font-black uppercase tracking-widest text-[#134e4a] flex items-center gap-2';
