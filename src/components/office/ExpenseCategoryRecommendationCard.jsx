    ...
    return (
      <div className="mb-3 rounded-xl border border-slate-200 bg-slate-50/90 px-3 py-3 flex gap-3">
        ...
        <div className="min-w-0">
          <p className="text-[9px] font-black uppercase tracking-wide text-slate-500">Suggested — needs approval</p>
    ...
    <div className="mb-3 rounded-xl border border-teal-200/90 bg-gradient-to-br from-teal-50/95 to-emerald-50/80 px-3 py-3 shadow-sm">
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[9px] font-black uppercase tracking-wide text-teal-900/75">
          ...
          {reason ? <p className="text-[10px] text-teal-900/85 mt-1.5 leading-snug">{reason}</p> : null}
          {onApply ? (
            <button
              type="button"
              onClick={onApply}
              className="mt-2.5 inline-flex items-center gap-1.5 rounded-lg bg-[#134e4a] px-3 py-1.5 text-[10px] font-black uppercase tracking-wide text-white hover:bg-[#0f3d3a] transition-colors"
            >
              Use category
