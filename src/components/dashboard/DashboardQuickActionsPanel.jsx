  ...
  return (
    <div className="z-card-muted">
      <h3 className="z-section-title flex items-center gap-2">
        <Zap size={14} className="text-zarewa-teal shrink-0" />
        Quick actions
      </h3>
      <div className="grid grid-cols-1 gap-3">
        <button
          ...
          className="flex items-center gap-3 bg-zarewa-teal text-white p-4 rounded-xl shadow-sm hover:brightness-[1.03] transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zarewa-teal/40 focus-visible:ring-offset-2"
        >
          <PlusCircle size={18} className="text-white/90 group-hover:rotate-90 transition-transform shrink-0" />
          <span className="font-bold text-xs uppercase tracking-wider">New quote</span>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <span className="font-bold text-xs uppercase text-left">Record payment</span>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <span className="font-bold text-xs uppercase text-left">New purchase</span>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <span className="font-bold text-xs uppercase text-left">Cutting list</span>
        </button>
        <button
          type="button"
        ...
        <button
          ...
          className="flex items-center gap-3 bg-gray-50 text-zarewa-teal p-4 rounded-xl border border-slate-200 hover:bg-white hover:border-slate-300 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zarewa-teal/25 focus-visible:ring-offset-2"
        >
          <Receipt size={18} className="text-slate-500 shrink-0" />
          <span className="font-bold text-xs uppercase text-left">Expense request</span>
        </button>
      </div>
    </div>
  );
