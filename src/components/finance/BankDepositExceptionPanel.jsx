    ...
    <div className="space-y-3 rounded-xl border border-amber-200/90 bg-amber-50/40 p-4 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <button
          ...
          onClick={() => void load()}
          disabled={loading}
          className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-2 py-1 text-[9px] font-bold uppercase text-slate-700 hover:bg-slate-50 disabled:opacity-50"
        >
      ...
      <div className="overflow-x-auto rounded-lg border border-amber-100 bg-white">
        <table className="min-w-full text-[10px]">
          <thead className="bg-amber-50/80 text-[9px] uppercase text-amber-900/80">
            <tr>
              ...
              exceptions.map((row) => {
                ...
                return (
                  <tr key={key} className="border-t border-amber-50 hover:bg-amber-50/30">
                    <td className="px-2 py-1.5 font-mono font-bold text-[#134e4a]">{row.depositId}</td>
                    ...
                    {canPost ? (
                      <td className="px-2 py-1.5 text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-md bg-amber-700 px-2 py-0.5 text-[9px] font-bold uppercase text-white disabled:opacity-50"
                        >
