  ...
  return (
    <div className="rounded-xl border border-violet-200/90 bg-violet-50/70 px-3 py-2.5 flex items-start gap-2">
      ...
      <div className="min-w-0">
        <p className="text-ui-xs font-black uppercase tracking-wide text-violet-950">Executive read-only</p>
        <p className="mt-0.5 text-xs text-violet-900/90 leading-snug">
