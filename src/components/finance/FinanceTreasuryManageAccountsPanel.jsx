    ...
    <section className="space-y-3 scroll-mt-20" data-testid="finance-desk-manage-accounts">
      {workspaceBranchLabel ? (
        <p className="text-[11px] text-slate-600 leading-relaxed rounded-xl border border-slate-200/80 bg-slate-50/80 px-4 py-3">
          ...
          <strong className="text-[#134e4a]">{workspaceBranchLabel}</strong>. Switch workspace to Yola or Maiduguri
          ...
          accounts.map((acc) => (
            ...
            >
              ...
              >
                ...
                <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-0.5">{acc.name}</p>
