...
const AI_BTN_CLASS =
  'inline-flex items-center gap-2 rounded-lg border border-teal-100 bg-teal-50 px-3 py-2 text-[10px] font-semibold uppercase tracking-wide text-[#134e4a] shadow-sm hover:bg-teal-100/70';
  ...
  return (
    <div className="flex w-full min-w-0 flex-wrap items-center justify-end gap-2">
      ...
      <ZareHelpButton
        ...
        className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[10px] font-semibold uppercase tracking-wide text-slate-700 shadow-sm hover:bg-slate-50"
        compact
      />
    </div>
  );
