  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-950">
        <p className="font-semibold">Legacy discipline log (read-only)</p>
        <p className="mt-1">
          New incidents must be opened as formal accountability cases. This register shows historical profile events only.
        </p>
        <Link
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        {!embedded ? (
          <p className="text-sm text-slate-600 max-w-2xl">
            Historical warnings and disciplinary actions stored on employee profiles before the accountability module.
          </p>
        ) : null}
      </div>
