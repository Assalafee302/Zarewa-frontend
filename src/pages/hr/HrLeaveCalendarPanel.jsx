...
/** HQ leave calendar — approved leave across branches in scope. */
export default function HrLeaveCalendarPanel() {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-slate-600">Approved leave in your HR scope — plan coverage and approvals.</p>
