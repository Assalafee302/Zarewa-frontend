      ...
      <MainPanel>
        <div className="flex min-w-0 w-full flex-wrap items-center justify-between gap-3 mb-6">
          ...
          <button
            ...
            onClick={() => void load()}
            disabled={loading}
            className="inline-flex items-center gap-2 rounded-sm border border-slate-200 bg-white px-4 py-2 text-ui-xs font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50"
          >
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 text-slate-400 gap-2">
            ...
            <p className="text-xs font-medium text-slate-500">Loading queue</p>
          </div>
        ) : items.length === 0 ? (
            ...
            {items.map((e) => (
              ...
              >
                ...
                <button
                  ...
                  className="shrink-0 rounded-sm bg-zarewa-teal px-4 py-2 text-ui-xs font-medium text-white hover:brightness-105 disabled:opacity-50"
                >
