  ...
  return (
    <MainPanel className="min-w-0">
      ...
      <div className="mb-4 flex flex-wrap items-end gap-3">
        <label className="block text-ui-xs font-medium text-slate-500">
          Price book as at (optional)
          <input
            type="date"
            className="mt-1 block rounded-md border border-slate-200 px-3 py-2 text-sm font-medium"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-sm border border-slate-300 bg-white px-4 py-2 text-xs font-medium text-slate-800 hover:bg-slate-50"
        >
          <Printer size={16} />
          Customer price book
        </button>
      ...
      {loading ? (
        ...
        <form onSubmit={save} className="max-w-4xl space-y-8">
          <section className="space-y-3 rounded-md border border-slate-200 bg-white p-5">
            <h2 className="text-sm font-semibold text-slate-900">Default trading band</h2>
          ...
          <section className="space-y-3 rounded-md border border-slate-200 bg-white p-5">
            <h2 className="text-sm font-semibold text-slate-900">Gauge tiers</h2>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm border-collapse">
                <thead>
                  <tr className="text-left text-ui-xs font-medium text-slate-500">
          ...
          <section className="space-y-3 rounded-md border border-slate-200 bg-white p-5">
            <div className="flex flex-wrap items-start justify-between gap-2">
              <div className="min-w-0">
                <h2 className="text-sm font-semibold text-slate-900">Ridge add-ons</h2>
            ...
            <div className="flex flex-wrap items-center gap-2">
              {canPolicy ? (
                <button
                  ...
                  className="rounded-sm border border-dashed border-slate-300 bg-white px-3 py-2 text-ui-xs font-medium text-slate-800 hover:bg-slate-50"
                >
                  Add ridge row
                </button>
              ) : null}
          ...
          <section className="space-y-3 rounded-md border border-slate-200 bg-white p-5">
            <h2 className="text-sm font-semibold text-slate-900">Profile / design aliases</h2>
          ...
          {canPolicy ? (
            <button
              type="submit"
              disabled={saving}
              className="rounded-sm bg-zarewa-teal px-5 py-2.5 text-xs font-medium text-white disabled:opacity-50"
            >
