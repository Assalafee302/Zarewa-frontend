...
const CORE_HELP_ARTICLES = [
  ...
  },
  {
    ...
    keywords: [
      ...
      'undo finish roll',
      'uncheck finish roll',
      'mistaken finish roll',
    ],
    answer:
      'If **Roll finished** / **Finish roll** cleared the coil by mistake, a **branch manager or above** must uncheck it and confirm. On a completed job: open the register → uncheck **Finish roll** → **Save correction** → tick **Confirm undo Finish roll**. On the coil profile: use **Undo finish roll** (confirm + note). Storekeepers cannot restore a finish-roll tail alone.',
    steps: [
      'Open the completed job → Fix wrong entry / edit coil lines (or open Coil profile if finished from profile).',
